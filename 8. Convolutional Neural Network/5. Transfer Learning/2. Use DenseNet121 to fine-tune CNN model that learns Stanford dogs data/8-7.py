...
base_model = DenseNet121(weights='imagenet', include_top=False, input_shape=(224,224,3)) # include_top=False means; don't add the fully connected layer in the back
cnn = Sequential()
cnn.add(Rescaling(1.0/255.0))
cnn.add(base_model) # add DenseNet121 here
cnn.add(Flatten())
